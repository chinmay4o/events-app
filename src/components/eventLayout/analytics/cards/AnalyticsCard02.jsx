          ...
          <div className="overflow-x-auto">
            <table className="table-auto w-full">
              ...
              <tbody className="text-sm divide-y divide-slate-100">
                ...
                <tr>
                  <td className="py-2">
                    <div className="text-left">flciker.com/events/eventId</div>
                  </td>
                  <td className="py-2">
                ...
                <tr>
                  <td className="py-2">
                    <div className="text-left">flciker.com/events/home</div>
                  </td>
                  <td className="py-2">
                    <div className="font-medium text-right text-slate-800">
                      42
                ...
                <tr>
                  <td className="py-2">
                    <div className="text-left">flicker.com/events/schedule</div>
                  </td>
                  <td className="py-2">
                    <div className="font-medium text-right text-slate-800">
                      12
                ...
                <tr>
                  <td className="py-2">
                    <div className="text-left">
                      flciker.com/events/eventId/connect
                    </div>
                  </td>
                  <td className="py-2">
                    <div className="font-medium text-right text-slate-800">
