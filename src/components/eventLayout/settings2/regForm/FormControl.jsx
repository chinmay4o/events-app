        ...
        // </select> */}
          {/* <div className="relative mb-[28px]">
            ...
            <div
              className={`${
                width ? `w-[${width}]` : "w-full"
              } peer bg-white border border-gray-300 text-gray-900 text-[12px] rounded-lg h-[35px] placeholder-transparent focus:ring-transparent focus:border-primary focus:border-[1.2px] block p-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white font-medium dark:focus:ring-blue-500 dark:focus:border-blue-500 flex justify-between items-center`}
            >
              <div className="flex">
                {multiplValue.map((o, index) => (
                  <div
                    key={index}
                    value={o.value}
                    className="text-[14px] mr-2 border flex justify-center items-center rounded-lg relative z-10"
                  >
                    <input
                      className="ml-1 w-[]"
                      value={o.label}
                    ...
                    <div
                      ...
                      onClick={() => {
                        setMultiplValue(
                          multiplValue.filter((value) => value._id !== o._id)
                        );
                      }}
                    >
                      <img
            ...
            {/* [...multiplValue, o] */}
          {/* {multiSelect && (
              <div className="border absolute bg-white w-full z-10 pl-2 text-gray-900 text-[14px] font-medium">
                {options.map((o, index) => (
                  <div
                    key={index}
                    className="cursor-pointer mb-1 border"
                    onClick={() => deleteValue(o)}
                  >
                    {o.label}
                  </div>
                ))}
